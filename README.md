...
All things Build & Release. This role manages the provisioning of build and release tools and services:
  ...
  * Aptly
  * …
**Usage**: by default, this role does nothing as all `*_state` variables are set to ignored. For the components you're interested in, set the `*_state` variables to present or absent.
